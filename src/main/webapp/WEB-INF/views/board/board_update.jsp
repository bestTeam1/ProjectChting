            ...
            <section>
                <div class="content">
                    <header>
                        ...
                        <form id="form" method="post" action='board_updateOk.do'>
                            ...
                            <div style="display: flex; justify-content: center">
                                ...
                                <button type="button" onclick="location.href='board_list.do?group_no=${plist.group_no}'">목록</button>
                            </div>
                            <input type="hidden" value="${plist.post_no}" name="post_no" >
