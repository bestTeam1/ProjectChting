...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/dashboard/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            회원</div>
                                        <div id="totalUser"  class="h5 mb-0 font-weight-bold text-gray-800"> id="totalUser" </div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            모임</div>
                                        <div id="totalGroup"  class="h5 mb-0 font-weight-bold text-gray-800">id="totalGroup"</div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            모임</div>
                                        <div id="totalEvent"  class="h5 mb-0 font-weight-bold text-gray-800">id="totalEvent"</div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                            가장 인기있는 관심사</div>
                                        <div id="totalInterest" class="h5 mb-0 font-weight-bold text-gray-800"> id = "totalInterest" </div>
                                    </div>
                                    <div class="col-auto">
