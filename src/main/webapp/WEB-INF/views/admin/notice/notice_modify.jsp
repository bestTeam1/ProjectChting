...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="row">
            <h1 style="text-align: center; margin-top: 50px">공지사항 수정</h1>
        </div>
        <!-- Main Content -->
        <!-- Start Service -->
        <section class="container my-lg-5">
            <form id="write" method="post" action='${pageContext.request.contextPath}/admin/adminNoticeModifyOk.do'
                ...
                <div class="service-wrapper py-3">
                    ...
                    <div class="pricing-list shadow-sm rounded-top rounded-3 py-sm-0 py-5">
                        ...
                        <textarea name="subject" id="subject" class="form-control form-control-lg light-300"
                                  style="resize: none; width: 800px; height: 80px; ">${detail.subject}</textarea>
                    ...
                    <div class="pricing-list shadow-sm rounded-top rounded-3 py-sm-0 py-5">
                        ...
                        <textarea name="content" id="content" class="form-control form-control-lg light-300"
                                  style="resize: none; width: 800px; height: 300px;"> ${detail.content}</textarea>
            ...
            <div style="display: flex; justify-content: center">
                ...
                <button type="button" class="banner-button btn rounded-pill btn-primary btn-lg px-4 my-lg-5"
                        onclick="location.href='${pageContext.request.contextPath}/admin/adminNotice.do?page=${page}">
                    목록
                </button>
            </div>
        </section>
