...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="row">
            <h1 style="text-align: center; margin-top: 50px">공지사항 등록</h1>
        </div>
        <!-- Main Content -->
        <!-- Start Service -->
        <section class="container my-lg-5">
            <form id="write" method="post" action='${pageContext.request.contextPath}/admin/noticeWriteOk.do'
            ...
            <div style="display: flex; justify-content: center">
                ...
                <button type="button" class="banner-button btn rounded-pill btn-primary btn-lg px-4 my-lg-5"
                        onclick="location.href='adminNotice.do?page=0'">목록
                </button>
            </div>
        </section>
